...
class GoogleMapsService:
    ...
    async def get_route(
        ...
        """Calculate route between pickup and delivery locations using Google Maps Directions API"""
    ...
    async def geocode_address(self, address: str) -> Optional[Dict[str, float]]:
        """Convert address text to latitude/longitude using Google Maps Geocoding API"""
    ...
    def _mock_route_data(pickup_lat: float, pickup_lng: float, delivery_lat: float, delivery_lng: float) -> Dict[str, Any]:
        """Generate mock route data for testing when API is unavailable"""
        import math
